                                ...
                                <div class="col-md-3 spcm">
                                    <div class="row">
                                         ...
                                         <div class="etqSideFront1">
                                            <span class="tiposE" >Piezas</span>
                                        </div>
                                    </div>
                                     <div class="row ">
                                         <div class="col-md-3 spcm">
                                             <div class="busQ"><input  type="search" placeholder="Buscar pieza" class="BUSE" id="tpE" data-inputbus="0" data-dependencia="0"><span class="fa fa-search"></span></div>
                                        </div> 
                                    </div>
