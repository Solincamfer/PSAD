                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="col-md-8 col-md-offset-2">
                                                <div class="form-group row" id="rPfl1">
                                                        ...
                                                        <label for="duPfl">Nombre de equipo</label>
                                                ...
                                                <div class="form-group row" id="rPfl2">                                                    
                                                        <label for="stPfl">Tipo de equipo</label>
                                                ...
                                                <div class="col-md-8 col-md-offset-2">
                                                <div class="form-group row" id="rPfl2">                                                    
                                                        <label for="stPfl">Marca de equipo</label>
                                                        <select name="stPfl" id="stPfl" class="form-control userEmail">
                                                            <option value="">-</option>
                                                            <option value="1">Activo</option>
                                                            <option value="2">Inactivo</option>
                                                 ...
                                                 <div class="col-md-8 col-md-offset-2">
                                                <div class="form-group row" id="rPfl2">                                                    
                                                        <label for="stPfl">Modelo de equipo</label>
                                                        <select name="stPfl" id="stPfl" class="form-control userEmail">
                                                            <option value="">-</option>
                                                            <option value="1">Activo</option>
                                                            <option value="2">Inactivo</option>
                                                ...
                                                <div class="col-md-8 col-md-offset-2">
                                                <div class="form-group row" id="rPfl2">                                                    
                                                        <label for="stPfl">Estatus de euipo</label>
                                                        <select name="stPfl" id="stPfl" class="form-control userEmail">
                                                            <option value="">-</option>
                                                            <option value="1">Activo</option>
                                                            <option value="2">Inactivo</option>
